<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom:0; background-color:cadetblue;">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="" style = "color:white;"><i class = "fa fa-institution fa-large" > </i> College Election System</a>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="candidate.php"><i class="fa fa-bars fa-fw"></i> Menu </a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-users fa-fw"></i> Candidates List<span class="fa arrow"></span></a>
                        ...
                        <li>
                            <a href="canvassing.php"><i class="fa fa-download fa-fw"></i> Result </a>
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="between_dates.php"> <i class = "fa fa-users" ></i> Between Dates Reports</a>
                                </li>
