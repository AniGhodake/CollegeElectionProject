    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
				...
				<a  href = "generate_password.php"class = "btn btn-success btn-outline pull-right" style = "margin-right:20px;" name = "go"><i class = "fa fa-refresh fa-spin"></i> Generate Voters Password</a>
				<br />
				<br />
                <a href="mail.php" class="btn btn-warning btn-outline pull-right" style = "margin-right:12px;" name = "go"><i class = "fa fa-envelope-square"></i> Send Email With ID & PASSWORD </a>
				
                <a href="../register/index.php" class = "btn btn-primary btn-outline"><i class = "fa fa-plus-square"></i> Add Voters</a>
