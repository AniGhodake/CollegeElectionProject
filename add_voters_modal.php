<div class="modal fade" id="add_voters" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
										...
										mysql_query ("INSERT INTO candidate(position,firstname,lastname,year,gender,img)values('$position','$firstname','$lastname','$year','$gender','$location')")or die(mysql_error());
