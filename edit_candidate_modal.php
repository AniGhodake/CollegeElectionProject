				...
				<form method = "post" enctype = "multipart/form-data">	
					...
					<div class="form-group">
						...
						<select class = "form-control" name = "position">
								...
								<option>UNIVERSITY REPRESENTATIVE (UR)</option>
...
<!-- /.modal-content -->
	...
	<?php 
		...
		if(ISSET($_POST['update'])){
			...
			$conn->query("UPDATE candidate SET position = '$position', firstname = '$firstname', lastname = '$lastname', year = '$year', gender = '$gender',img='$location' WHERE candidate_id = '$candidate_id'")or die(mysql_error());
